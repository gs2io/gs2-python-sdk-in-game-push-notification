...
class CreateGameRequest(Gs2BasicRequest):
    ...
    def set_offline_transfer(self, offline_transfer):
        ...
        """
        if offline_transfer is not None and not (isinstance(offline_transfer, str) or isinstance(offline_transfer, unicode)):
    ...
    def set_notification_firebase_server_key(self, notification_firebase_server_key):
        ...
        """
        if notification_firebase_server_key is not None and not (isinstance(notification_firebase_server_key, str) or isinstance(notification_firebase_server_key, unicode)):
    ...
    def set_create_certificate_trigger_script(self, create_certificate_trigger_script):
        ...
        """
        if create_certificate_trigger_script is not None and not (isinstance(create_certificate_trigger_script, str) or isinstance(create_certificate_trigger_script, unicode)):
    ...
    def set_create_certificate_done_trigger_script(self, create_certificate_done_trigger_script):
        ...
        """
        if create_certificate_done_trigger_script is not None and not (isinstance(create_certificate_done_trigger_script, str) or isinstance(create_certificate_done_trigger_script, unicode)):
    ...
    def set_delete_certificate_trigger_script(self, delete_certificate_trigger_script):
        ...
        """
        if delete_certificate_trigger_script is not None and not (isinstance(delete_certificate_trigger_script, str) or isinstance(delete_certificate_trigger_script, unicode)):
    ...
    def set_delete_certificate_done_trigger_script(self, delete_certificate_done_trigger_script):
        ...
        """
        if delete_certificate_done_trigger_script is not None and not (isinstance(delete_certificate_done_trigger_script, str) or isinstance(delete_certificate_done_trigger_script, unicode)):
    ...
    def set_publish_trigger_script(self, publish_trigger_script):
        ...
        """
        if publish_trigger_script is not None and not (isinstance(publish_trigger_script, str) or isinstance(publish_trigger_script, unicode)):
    ...
    def set_publish_done_trigger_script(self, publish_done_trigger_script):
        ...
        """
        if publish_done_trigger_script is not None and not (isinstance(publish_done_trigger_script, str) or isinstance(publish_done_trigger_script, unicode)):
    ...
    def set_set_firebase_token_trigger_script(self, set_firebase_token_trigger_script):
        ...
        """
        if set_firebase_token_trigger_script is not None and not (isinstance(set_firebase_token_trigger_script, str) or isinstance(set_firebase_token_trigger_script, unicode)):
    ...
    def set_set_firebase_token_done_trigger_script(self, set_firebase_token_done_trigger_script):
        ...
        """
        if set_firebase_token_done_trigger_script is not None and not (isinstance(set_firebase_token_done_trigger_script, str) or isinstance(set_firebase_token_done_trigger_script, unicode)):
